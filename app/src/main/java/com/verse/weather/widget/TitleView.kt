...
class TitleView(context: Context, attrs: AttributeSet?) : LinearLayout(context, attrs) {
    ...
    private fun initAttrs(context: Context, attrs: AttributeSet?) {
        ...
        this.defaultTitleTextSize =
            TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, defaultTitleTextSize.toFloat(), dm).toInt()
        ...
        titleTextColor =
            typedArray.getColor(R.styleable.TitleView_titleViewTextColor, resources.getColor(defaultTitleTextColorId))
        titleBackgroundColor = typedArray.getColor(
            R.styleable.TitleView_titleViewBackground,
            resources.getColor(defaultTitleBackgroundColorId)
        )
        titleLineColor =
            typedArray.getColor(R.styleable.TitleView_titleViewLineColor, resources.getColor(defaultTitleLineColorId))
        typedArray.recycle()
    }
