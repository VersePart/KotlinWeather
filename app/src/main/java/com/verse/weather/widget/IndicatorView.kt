...
class IndicatorView(context: Context, attrs: AttributeSet) : LinearLayout(context, attrs) {
    ...
    private var contextIndicator: Context? = null
    ...
    internal var indicatorColorIds: IntArray? = null
    ...
    private fun init(context: Context, attrs: AttributeSet) {
        ...
        this.setPadding(
            this.paddingLeft + this.marker!!.width / 2,
    ...
    private fun initAttrs(attrs: AttributeSet) {
        ...
        this.indicatorStringsResourceId =
            typedArray.getInt(R.styleable.IndicatorView_indicatorStrings, indicatorStringsResourceId)
